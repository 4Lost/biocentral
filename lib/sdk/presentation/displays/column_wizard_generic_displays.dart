  ...
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        return widget.columnWizard.compare ? buildCompare(context, snapshot.data!) : buildSingle(context, snapshot.data!);
      },
    );
  }

  Widget buildSingle(BuildContext context, bool handleAsDiscrete) {
    if (handleAsDiscrete) {
      return Row(
